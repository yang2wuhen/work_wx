...
public class ContactModel {
    ...
    private int[]  department;	// 成员所属部门id列表，仅返回该应用有查看权限的部门id
    private int[]  order;         //	部门内的排序值，32位整数，默认为0。数量必须和department一致，数值越大排序越前面。
    private String position;    //	职务信息；第三方仅通讯录应用可获取
    private String gender;      //	性别。0表示未定义，1表示男性，2表示女性
    private String email;       //	邮箱，第三方仅通讯录应用可获取
    private int[] is_leader_in_dept;    //	表示在所在的部门内是否为上级；第三方仅通讯录应用可获取
    ...
    private int enable;            //	成员启用状态。1表示启用的成员，0表示被禁用。服务商调用接口不会返回此字段
    private String alias;           //	别名；第三方仅通讯录应用可获取
    private int    status;          //	激活状态: 1=已激活，2=已禁用，4=未激活 已激活代表已激活企业微信或已关注微工作台（原企业号）。
    ...
    private int  hide_mobile;       //	是否隐藏手机号
